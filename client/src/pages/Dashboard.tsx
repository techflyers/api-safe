...
const Dashboard: React.FC = () => {
  ...
  const fetchApiKeys = async () => {
    try {
      const response = await axios.get('https://apisafegui-techflyervp.ladeapp.com/api/keys');
  ...
  const handleAddKey = async () => {
    try {
      ...
      await axios.post('https://apisafegui-techflyervp.ladeapp.com/api/keys', {
        keyName,
        apiKey,
  ...
  const handleUpdateKey = async () => {
    try {
      ...
      await axios.put(`https://apisafegui-techflyervp.ladeapp.com/api/keys/${selectedKey.keyName}`, {
        apiKey,
        providers: selectedProviders,
        type: keyType,
      });
  ...
  const handleDeleteKey = async (keyName: string) => {
    try {
      await axios.delete(`https://apisafegui-techflyervp.ladeapp.com/api/keys/${keyName}`);
      fetchApiKeys();
    } catch (err) {
